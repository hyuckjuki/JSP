...
public class DBCPBoardDao {
	 ...
	 * 여기서는 JNDI 방식으로 DBCP를 찾아 DBCP에서 Connection 객체를 대여하는 객체 
	 **/
	private DataSource ds;
	
	/* 기본 생성자가 호출될 때 마다 ConnectionPool에 접근해  Connection 객체를
	 * 얻어 올 수 있는 DataSource 객체를 생성하고 DBCP로부터 Connection을 대여한다.
	 **/
	public DBCPBoardDao() {
		...
		try {
			...
			/* 3. "jdbc/membersDBPool"이라는 이름을 가진 DBCP에서 
			 * DataSource 객체를 얻는다.
			 *
			...
			System.out.println("DBCPBoardDao() : NamingException");
			e.printStackTrace();
	...
	public ArrayList<Board> boardList() {
		...
		try {
			...
			System.out.println("DBCPBoardDao - boardList() - SQLException");
			e.printStackTrace();
	...
	public Board getBoard(int no) {
		...
		try {		
			...
			System.out.println("DBCPBoardDao - getBoard() : SQLException");
			e.printStackTrace();
	...
	public void insertBoard(Board board) {
		...
		try {
			...
			System.out.println("DBCPBoardDao - insertBoard() : SQLException");
			e.printStackTrace();
	...
	public boolean isPassCheck(int no, String pass) {
		...
		try {
			...
			System.out.println("DBCPBoardDao - isPassCheck() : SQLException");
			e.printStackTrace();
	...
	public void updateBoard(Board board) {
		...
		try {
			...
			System.out.println("DBCPBoardDao - updateBoard() : SQLException");
			e.printStackTrace();
