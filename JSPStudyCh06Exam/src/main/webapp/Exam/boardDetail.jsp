...
// 		response.sendRedirect("boardList.jsp");
	...
	ExamVo b = dao.getBoard(Integer.parseInt(no));
...
<link href="../css/myboard.css" type="text/css" rel="stylesheet">
...
<table style="width: 600px;">
	...
	<tr>
		...
		<td class="contentTd">
			<fmt:formatDate value="<%=b.getWdate() %>" pattern="yyyy-MM-dd"/>
		</td>
	</tr>
	<tr>		
		...
		<td class="contentTd"><%= b.getVocal() %></td>
	</tr>	
	<tr>
		<td class="contentTh">파&nbsp;&nbsp;&nbsp;&nbsp;일</td>
		<td class="contentTd" colspan="3">
		<c:if test='<%= b.getCover() == null || b.getCover().equals("")%>'>
			첨부파일 없음
		</c:if>
		<c:if test='<%= b.getCover() != null && !b.getCover().equals("")%>'>
			<a href="../upload/<%= b.getCover() %>">파일 다운로드</a>
		</c:if>
		</td>		
	</tr>
	<tr>		
		<td style="text-align:center;" class="readContent" colspan="4" style="white-space: pre;"><%= b.getContent() %></td>
	</tr>	
	<tr>
		<td colspan="4">&nbsp;</td>
	</tr>
