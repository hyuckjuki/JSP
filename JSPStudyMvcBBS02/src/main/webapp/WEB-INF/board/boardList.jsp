...
<table class="listTable">
	...
	<c:if test="${ searchOption }">
	<tr>			
		<td colspan="2" class="boardListLink"><a href="boardList.mvc">리스트</a></td>
		...
		<td colspan="5" class="listPage">
			 ...
			 * startPage로 이동할 수 있다.
		 	...
		 	<c:if test="${ startPage > pageGroup }">
				<a href="boardList.mvc?pageNum=${ startPage - pageGroup }
			...
			<c:forEach var="i" begin="${ startPage }" end="${ endPage }">
				...
				<c:if test="${ i != currentPage }">
					<a href="boardList.mvc?pageNum=${ i }&type=${ type }
						&keyword=${ keyword }">[ ${ i } ]</a>
				</c:if>			
			</c:forEach>
			<%-- 
